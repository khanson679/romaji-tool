...
KUNREI = RomajiFormat(
    "Kunrei",
    Mapping(ROMAJI_MAP_BASE + ROMAJI_MAP_KUNREI, out_map=ROMAJI_MAP_KUNREI_OUTONLY),
    NASAL_MAP_DEFAULT,
    Mapping(SOKUON_MAP_BASE),
    Mapping(CHOUON_MAP_CIRCUMFLEX))
...
HEPBURN_STRICT = RomajiFormat(
    "Hepburn Strict",
    Mapping(ROMAJI_MAP_BASE + ROMAJI_MAP_HEPBURN, out_map=ROMAJI_MAP_HEPBURN_OUTONLY),
    NASAL_MAP_DEFAULT,
...
HEPBURN = RomajiFormat(
    "Hepburn",
    Mapping(ROMAJI_MAP_BASE + ROMAJI_MAP_HEPBURN + ROMAJI_MAP_HEPBURN_EXTENDED
